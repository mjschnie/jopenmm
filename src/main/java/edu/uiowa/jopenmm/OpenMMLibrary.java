...
public class OpenMMLibrary implements Library {
     ...
     * enum values
     */
    public interface OpenMM_Boolean {
        int OpenMM_False = 0;
        int OpenMM_True = 1;
    }
     ...
     * enum values
     */
    public interface OpenMM_GayBerneForce_NonbondedMethod {
        int OpenMM_GayBerneForce_NoCutoff = 0;
        int OpenMM_GayBerneForce_CutoffNonPeriodic = 1;
        int OpenMM_GayBerneForce_CutoffPeriodic = 2;
    }

    /**
     * enum values
     */
    public interface OpenMM_GBSAOBCForce_NonbondedMethod {
        int OpenMM_GBSAOBCForce_NoCutoff = 0;
        int OpenMM_GBSAOBCForce_CutoffNonPeriodic = 1;
        int OpenMM_GBSAOBCForce_CutoffPeriodic = 2;
    }

    /**
     * enum values
     */
    public interface OpenMM_CustomNonbondedForce_NonbondedMethod {
        int OpenMM_CustomNonbondedForce_NoCutoff = 0;
        int OpenMM_CustomNonbondedForce_CutoffNonPeriodic = 1;
        int OpenMM_CustomNonbondedForce_CutoffPeriodic = 2;
    }

    /**
     * enum values
     */
    public interface OpenMM_MonteCarloMembraneBarostat_XYMode {
        int OpenMM_MonteCarloMembraneBarostat_XYIsotropic = 0;
        int OpenMM_MonteCarloMembraneBarostat_XYAnisotropic = 1;
    }

    /**
     * enum values
     */
    public interface OpenMM_MonteCarloMembraneBarostat_ZMode {
        int OpenMM_MonteCarloMembraneBarostat_ZFree = 0;
        int OpenMM_MonteCarloMembraneBarostat_ZFixed = 1;
        int OpenMM_MonteCarloMembraneBarostat_ConstantVolume = 2;
    }

    /**
     * enum values
     */
    public interface OpenMM_NonbondedForce_NonbondedMethod {
        int OpenMM_NonbondedForce_NoCutoff = 0;
        int OpenMM_NonbondedForce_CutoffNonPeriodic = 1;
        int OpenMM_NonbondedForce_CutoffPeriodic = 2;
        int OpenMM_NonbondedForce_Ewald = 3;
        int OpenMM_NonbondedForce_PME = 4;
        int OpenMM_NonbondedForce_LJPME = 5;
    }

    /**
     * enum values
     */
    public interface OpenMM_CustomGBForce_NonbondedMethod {
        int OpenMM_CustomGBForce_NoCutoff = 0;
        int OpenMM_CustomGBForce_CutoffNonPeriodic = 1;
        int OpenMM_CustomGBForce_CutoffPeriodic = 2;
    }

    /**
     * enum values
     */
    public interface OpenMM_CustomGBForce_ComputationType {
        int OpenMM_CustomGBForce_SingleParticle = 0;
        int OpenMM_CustomGBForce_ParticlePair = 1;
        int OpenMM_CustomGBForce_ParticlePairNoExclusions = 2;
    }

    /**
     * enum values
     */
    public interface OpenMM_CustomManyParticleForce_NonbondedMethod {
        int OpenMM_CustomManyParticleForce_NoCutoff = 0;
        int OpenMM_CustomManyParticleForce_CutoffNonPeriodic = 1;
        int OpenMM_CustomManyParticleForce_CutoffPeriodic = 2;
    }

    /**
     * enum values
     */
    public interface OpenMM_CustomManyParticleForce_PermutationMode {
        int OpenMM_CustomManyParticleForce_SinglePermutation = 0;
        int OpenMM_CustomManyParticleForce_UniqueCentralParticle = 1;
    }

    /**
     * enum values
     */
    public interface OpenMM_CustomIntegrator_ComputationType {
        int OpenMM_CustomIntegrator_ComputeGlobal = 0;
        int OpenMM_CustomIntegrator_ComputePerDof = 1;
        int OpenMM_CustomIntegrator_ComputeSum = 2;
        int OpenMM_CustomIntegrator_ConstrainPositions = 3;
        int OpenMM_CustomIntegrator_ConstrainVelocities = 4;
        int OpenMM_CustomIntegrator_UpdateContextState = 5;
        int OpenMM_CustomIntegrator_IfBlockStart = 6;
        int OpenMM_CustomIntegrator_WhileBlockStart = 7;
        int OpenMM_CustomIntegrator_BlockEnd = 8;
    }

    /**
     * enum values
     */
    public interface OpenMM_State_DataType {
        int OpenMM_State_Positions = 1;
        int OpenMM_State_Velocities = 2;
        int OpenMM_State_Forces = 4;
        int OpenMM_State_Energy = 8;
        int OpenMM_State_Parameters = 16;
        int OpenMM_State_ParameterDerivatives = 32;
    }

    /**
     * enum values
     */
    public interface OpenMM_CustomHbondForce_NonbondedMethod {
        int OpenMM_CustomHbondForce_NoCutoff = 0;
        int OpenMM_CustomHbondForce_CutoffNonPeriodic = 1;
        int OpenMM_CustomHbondForce_CutoffPeriodic = 2;
    }
