...
public class AmoebaOpenMMLibrary implements Library {
     ...
     * enum values
     */
    public interface OpenMM_AmoebaMultipoleForce_NonbondedMethod {
        int OpenMM_AmoebaMultipoleForce_NoCutoff = 0;
        int OpenMM_AmoebaMultipoleForce_PME = 1;
    }

    /**
     * enum values
     */
    public interface OpenMM_AmoebaMultipoleForce_PolarizationType {
        int OpenMM_AmoebaMultipoleForce_Mutual = 0;
        int OpenMM_AmoebaMultipoleForce_Direct = 1;
        int OpenMM_AmoebaMultipoleForce_Extrapolated = 2;
    }

    /**
     * enum values
     */
    public interface OpenMM_AmoebaMultipoleForce_MultipoleAxisTypes {
        int OpenMM_AmoebaMultipoleForce_ZThenX = 0;
        int OpenMM_AmoebaMultipoleForce_Bisector = 1;
        int OpenMM_AmoebaMultipoleForce_ZBisect = 2;
        int OpenMM_AmoebaMultipoleForce_ThreeFold = 3;
        int OpenMM_AmoebaMultipoleForce_ZOnly = 4;
        int OpenMM_AmoebaMultipoleForce_NoAxisType = 5;
        int OpenMM_AmoebaMultipoleForce_LastAxisTypeIndex = 6;
    }

    /**
     * enum values
     */
    public interface OpenMM_AmoebaMultipoleForce_CovalentType {
        int OpenMM_AmoebaMultipoleForce_Covalent12 = 0;
        int OpenMM_AmoebaMultipoleForce_Covalent13 = 1;
        int OpenMM_AmoebaMultipoleForce_Covalent14 = 2;
        int OpenMM_AmoebaMultipoleForce_Covalent15 = 3;
        int OpenMM_AmoebaMultipoleForce_PolarizationCovalent11 = 4;
        int OpenMM_AmoebaMultipoleForce_PolarizationCovalent12 = 5;
        int OpenMM_AmoebaMultipoleForce_PolarizationCovalent13 = 6;
        int OpenMM_AmoebaMultipoleForce_PolarizationCovalent14 = 7;
        int OpenMM_AmoebaMultipoleForce_CovalentEnd = 8;
    }

    /**
     * enum values
     */
    public interface OpenMM_AmoebaVdwForce_NonbondedMethod {
        int OpenMM_AmoebaVdwForce_NoCutoff = 0;
        int OpenMM_AmoebaVdwForce_CutoffPeriodic = 1;
    }
